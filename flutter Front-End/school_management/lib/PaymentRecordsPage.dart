...
class _CalculateFeesPageState extends State<CalculateFeesPage> {
  ...
  final List<String> _feeTypes = [
    'Monthly Fee', 'Exam Fee', 'Registration Fee', 'Library Fee', 'Sports Fee'
  ];
  ...
  void _updateFixedAmount() {
    ...
    if (_studentClass.contains('1st') ||
      ...
      switch (_selectedFeeType) {
        case 'Monthly Fee': amount = 800.0; break;
        case 'Exam Fee': amount = 700.0; break;
        case 'Registration Fee': amount = 500.0; break;
        case 'Library Fee': amount = 300.0; break;
        case 'Sports Fee': amount = 400.0; break;
      }
    } else if (_studentClass.contains('6th') ||
        _studentClass.contains('7th') ||
        _studentClass.contains('8th')) {
      switch (_selectedFeeType) {
        case 'Monthly Fee': amount = 1200.0; break;
        case 'Exam Fee': amount = 700.0; break;
        case 'Registration Fee': amount = 1600.0; break;
        case 'Library Fee': amount = 400.0; break;
        case 'Sports Fee': amount = 500.0; break;
      }
    } else if (_studentClass.contains('9th') ||
        _studentClass.contains('10th')) {
      switch (_selectedFeeType) {
        case 'Monthly Fee': amount = 1500.0; break;
        case 'Exam Fee': amount = 1000.0; break;
        case 'Registration Fee': amount = 3300.0; break;
        case 'Library Fee': amount = 700.0; break;
        case 'Sports Fee': amount = 500.0; break;
      }
    }
                  ...
                  children: [
                    ...
                    if (_studentName.isNotEmpty && _studentClass.isNotEmpty)
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Student Name: $_studentName', style: TextStyle(fontSize: 16)),
                          Text('Class: $_studentClass', style: TextStyle(fontSize: 16)),
                          SizedBox(height: 16),
                        ],
                      ),
                    DropdownButtonFormField<String>(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    ...
                    duration: Duration(seconds: 2), // The message will be displayed for 2 seconds
                  ),
                );
