...
class _CalculateMarksPageState extends State<CalculateMarksPage> {
  ...
  void _updateSubjects() {
    ...
    setState(() {
      ...
      if (className == '1st' || className == '2nd' || className == '3rd' || className == '4th' || className == '5th') {
        _subjects.addAll(['Bangla', 'English', 'Mathematics', 'Science']);
      } else if (className == '6th' || className == '7th' || className == '8th') {
        _subjects.addAll(['Bangla', 'English', 'Mathematics', 'Science', 'Religion', 'Sociology', 'Agriculture']);
        ...
        _subjects.addAll(['Bangla', 'English', 'General Math', 'Religion', 'Physics', 'Chemistry', 'Biology']);
        ...
        _subjects.addAll(['Bangla', 'English', 'Math', 'Finance', 'Accounting']);
      }
  ...
  void _calculateResult() {
    ...
    _averageGrade = grades.isEmpty ? 0.0 : grades.reduce((a, b) => a + b) / grades.length;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Calculate Marks and Grade'),
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              _buildInputField(
                  controller: _examTitleController, label: 'Exam Title'),//newly added
              _buildInputField(
      ...
      child: Padding(
        ...
        child: Table(
          ...
          children: [
            ...
            _buildTableRow(
                'Obtain Grade', _averageGrade.toStringAsFixed(2)),
